...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData_21June = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWWTightMu/21Jun2016_Run2016B_PromptReco/WgStarsel__hadd__EpTCorr/";
  ...
  if (theSample == "DataRun2015") {
    ...
    // Luminosity 2.79 + 1.55 (21June + 05Jul) fb^-1 from Twiki,
    // https://twiki.cern.ch/twiki/bin/viewauth/CMS/LatinosTreesRun2
  	...
  	tree->Add( filesPathData_21June + "latino_Run2016B_PromptReco_SingleMuon.root");
