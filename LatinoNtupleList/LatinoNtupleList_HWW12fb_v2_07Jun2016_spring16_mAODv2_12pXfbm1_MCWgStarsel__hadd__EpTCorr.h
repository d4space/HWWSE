...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathMC = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWW12fb_v2/07Jun2016_spring16_mAODv2_12pXfbm1/MCWgStarsel__hadd__EpTCorr";
  ...
  if (theSample == "DataRun2015") {
    	...
    	tree->Add( filesPathMC + "latino_WZTo3LNu_mllmin01.root");
