...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWW6p3/05Jul2016_Run2016B_PromptReco/l2loose__hadd__EpTCorr__l2tight/";
  ...
  if (theSample == "DataRun2015") {
    ...
    // Luminosity 1.546 fb^-1 from twiki,
