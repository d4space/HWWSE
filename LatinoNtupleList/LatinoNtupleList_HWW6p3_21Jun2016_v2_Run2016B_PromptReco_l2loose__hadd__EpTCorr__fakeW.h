...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWW6p3/21Jun2016_v2_Run2016B_PromptReco/l2loose__hadd__EpTCorr__fakeW12fb/";
  ...
  if (theSample == "DataRun2015") {
    ...
    // Luminosity 2.791 fb^-1 from twiki,
