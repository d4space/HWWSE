...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData = "dcap://cluster142.knu.ac.kr//pnfs/knu.ac.kr/data/cms/store/user/spak/Latino_CernBox/80Xv2/Old_MediumMuID/07Jun2016_Run2016B_PromptReco/l2loose16bis__hadd__l2tight/";
  ...
  if (theSample == "DataRun2015") {
    ...
    // Luminosity : 0.8 fb pb^-1 from Xavier mail,
