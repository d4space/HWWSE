...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathMC_WgStar = "/u/user/sangilpark/Latino_CernBox/80Xv2/07Jun2016_spring16_mAODv2/MCWgStarsel__hadd__EpTCorr/";
    ...
    // https://groups.cern.ch/group/latinos-hep/Lists/Archive/Flat.aspx?RootFolder=%2Fgroup%2Flatinos%2Dhep%2FLists%2FArchive%2F805%20pb%2D1%20of%20data%20post%2Dprocessed&FolderCTID=0x012002005F41232413B3A741AEE1524B81D499EF
 	...
 	tree->Add( filesPathMC + "latino_WJetsToLNu_HT2500_inf.root");
  	...
  	//tree->Add( filesPathMC + "latino_DYJetsToLL_M-10to50-LO.root");
    	...
    	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-10to50.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0000__part0.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0000__part1.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0000__part2.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0000__part3.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0000__part4.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0001__part0.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0001__part1.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0001__part2.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0001__part3.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0001__part4.root");
  	tree->Add( filesPathMC_WgStar + "latino_DYJetsToLL_M-50_0002__part0.root");
  	...
  	tree->Add( filesPathMC_WgStar + "latino_WgStarLNuMuMu.root");
  }else if (theSample == "WgammaStarToLNuEE") {
  	tree->Add( filesPathMC_WgStar + "latino_WgStarLNuEE.root");
