...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWW12fb/26Jul2016_Run2016D_PromptReco/WgStarsel__hadd__ICHEPjson__EpTCorr/";
  ...
  }else if (theSample == "DataRun2016_D") {
  	tree->Add( filesPathData + "latino_Run2016D_PromptReco_SingleMuon.root");
