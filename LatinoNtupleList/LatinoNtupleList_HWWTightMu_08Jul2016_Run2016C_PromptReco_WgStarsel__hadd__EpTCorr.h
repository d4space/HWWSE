...
void ConnectTree(TChain* tree, TString theSample, Bool_t runAtLxplus){
  ...
  filesPathData = "/u/user/sangilpark/Latino_CernBox/80Xv2/HWWTightMu/08Jul2016_Run2016C_PromptReco/WgStarsel__hadd__EpTCorr/";
  ...
  if (theSample == "DataRun2015") {
    ...
    // Luminosity 0.378 fb^-1 from twiki,
    // https://twiki.cern.ch/twiki/bin/viewauth/CMS/LatinosTreesRun2
  	tree->Add( filesPathData + "latino_Run2016C_PromptReco_SingleMuon.root");
