...
root -l -q Results/Asimov.higgsCombineTest.MultiDimFit.012j.StandardModel-7TeV-8TeV.root \
           Results/Observed.higgsCombineTest.MultiDimFit.012j.StandardModel-7TeV-8TeV.root \
           drawExpObsResult.cxx\(1,\"012j\ \ \",20\)
           #drawExpObsResult.cxx\(1,\"012j\ \ \"\)
mv cc.png   Results/hwidth_hww_all_HiggsWidthLT_HWidthLT_WidthFloatMu.png
mv cc.pdf   Results/hwidth_hww_all_HiggsWidthLT_HWidthLT_WidthFloatMu.pdf
