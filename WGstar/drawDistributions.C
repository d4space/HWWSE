...
// syst. / yield for the 0-jet bin. These numbers are for the WW study. We need to calculate systematic uncertainty for the case ggH
  ...
  // Read input files
  //----------------------------------------------------------------------------
  TString path_MC   = Form("rootfiles_mll_110_met25pt30tight103/%djet/%s/", _njet, _channel.Data());
  TString path_Data = Form("rootfiles_mll_110_met25pt30tight103/%djet/%s/", _njet, _channel.Data());
