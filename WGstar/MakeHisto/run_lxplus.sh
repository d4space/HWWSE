# Usage at lxplus eos cernbox

# 1. Make folder for eos cernbox mount :  $ mkdir -p ~/eos_cernbox
# 2. Mount eos cernbox : $ /afs/cern.ch/project/eos/installation/0.3.84-aquamarine.user/bin/eos.select -b fuse mount ~/eos_cernbox
# 3. Change LatinosTreeScript to run at lxplus: runAtLxplus = true;
# 4. $./run_lxplus.sh NJETS
...
for CHANNEL in $CHANNELS; do
	...
	root -l -b -q "LatinosTreeScript_dcap_WgStarSel_v3_EpTCorr.C+($LUMINOSITY,$NJETS,\"$CHANNEL\",\"$SAMPLE\",\"Nominal\",\"true\")"
