		...
		Bool_t  verbose)
{
  ...
  if (theSample == "DataRun2015_D") {
  	...
  	tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_WZTo3LNu.root");
  }
	...
	//tree->Add(filesPath + "21Oct_25ns_MC/mcwghtcount__MC__l2sel/" + "latino_TTWJetsToLNu.root");
  	...
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_DYJetsToLL_M-50-LO.root"); // madgraph
  }
  	...
  	tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_Wg500.root");
  	tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_Wg_AMCNLOFXFX.root");
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_Wg_MADGRAPHMLM.root"); // madgraph
  }
  	...
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_GluGluHToWWTo2L2NuPowheg_M125.root"); // powheg
	...
	tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_VBFHToTauTau_M125.root");
  	...
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_VBFHToWWTo2L2NuHerwigPS_M125.root"); // herwig
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_VBFHToWWTo2L2NuPowheg_M125.root"); // powheg
  	tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_VBFHToWWTo2L2Nu_M125.root"); // JHUgenv628_pythia8
  	//tree->Add(filesPath + "22Jan_25ns_mAODv2_MC/MCl2loose__hadd/" + "latino_VBFHToWWTo2L2Nu_alternative_M125.root"); // JHUgen_pythia8
